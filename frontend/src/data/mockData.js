...
export const OPPORTUNITIES = [
  ...
  },
  {
    ...
    verified: true,
    cover: "https://images.unsplash.com/photo-1504674900247-0877df9cc836?crop=entropy&cs=srgb&fm=jpg&w=940&q=85",
    title: "Street Food Reel Series",
    pitch: "Take us on a street food tour of your city — we'll sponsor the whole trip.",
    payout: 1200,
    deadline: "18 June 2025",
    creatorsNeeded: 6,
    category: "Food",
    description: "We want 60-second reels capturing real street food moments — no studio, just vibes, flavours and your honest reaction.",
    requirements: ["8K+ Followers", "Food/Lifestyle niche", "Location: Tier 1 cities"],
  ...
  },
  {
    ...
    brandCategory: "Food & Beverage",
    verified: false,
    cover: "https://images.unsplash.com/photo-1556742049-0cfed4f6a45d?crop=entropy&cs=srgb&fm=jpg&w=940&q=85",
    title: "Morning Chai Ritual Campaign",
    pitch: "Share your morning chai ritual with our new premium blend.",
    payout: 400,
    deadline: "22 June 2025",
    creatorsNeeded: 15,
    category: "Food",
    description: "Cosy, authentic, real — show us how chai fits into your morning. We welcome all niches, not just food creators.",
    requirements: ["2K+ Followers", "Any niche", "Lifestyle-forward content"],
    language: ["Hindi", "Bengali", "Marathi", "Gujarati"],
    applicants: 29,
  },
  {
    id: "op-7",
    ...
    brandCategory: "Tech",
    verified: true,
    cover: "https://images.unsplash.com/photo-1505740420928-5e560c06d30e?crop=entropy&cs=srgb&fm=jpg&w=940&q=85",
    title: "boAt Earbuds Unboxing Collab",
    pitch: "Be our voice — review our latest earbuds in your signature style.",
    payout: 1500,
    deadline: "30 June 2025",
    creatorsNeeded: 20,
    category: "Tech",
    description: "Honest, engaging unboxing reels for our newest earbuds. We want real opinions, not scripts — your audience trusts you.",
    requirements: ["20K+ Followers", "Tech or Lifestyle niche", "Reel + Story deliverable"],
    language: ["Hindi", "English"],
    applicants: 88,
  },
  {
    id: "op-8",
    brandId: "brand-10",
    brandName: "WanderLens",
    brandCategory: "Travel",
    verified: true,
    cover: "https://images.unsplash.com/photo-1476514525535-07fb3b4ae5f1?crop=entropy&cs=srgb&fm=jpg&w=940&q=85",
    title: "Hidden Gems Travel Series",
    pitch: "Explore India's lesser-known destinations with WanderLens as your sponsor.",
    payout: 2000,
    deadline: "15 July 2025",
    creatorsNeeded: 4,
    category: "Lifestyle",
    description: "A fully-sponsored 3-day trip to a hidden gem destination. You create content, we handle logistics. Looking for storytellers, not just photographers.",
    requirements: ["15K+ Followers", "Travel or Lifestyle niche", "3 Reels + 10 Stories"],
    language: ["Hindi", "English"],
    applicants: 120,
  },
  {
    id: "op-9",
    brandId: "brand-11",
    brandName: "Sunday Minimal",
    brandCategory: "Lifestyle",
    verified: false,
    cover: "https://images.unsplash.com/photo-1493934558415-9d19f0b2b4d2?crop=entropy&cs=srgb&fm=jpg&w=940&q=85",
    title: "Minimal Living Aesthetic Campaign",
    pitch: "Showcase our home décor products in your everyday lifestyle content.",
    payout: 650,
    deadline: "8 July 2025",
    creatorsNeeded: 9,
    category: "Lifestyle",
    description: "Sunday Minimal makes clean, affordable home décor. We want creators who genuinely live a minimal aesthetic — real homes, real setups.",
    requirements: ["5K+ Followers", "Lifestyle or Home niche", "High-quality visual content"],
  ...
  },
  {
    ...
    verified: true,
    cover: "https://images.unsplash.com/photo-1522335789203-aabd1fc54bc9?crop=entropy&cs=srgb&fm=jpg&w=940&q=85",
    title: "Toxin-Free Skincare Routine",
    pitch: "Show your clean skincare routine using Mamaearth's toxin-free range.",
    payout: 800,
    deadline: "3 July 2025",
    creatorsNeeded: 7,
    category: "Beauty",
    description: "We want real 'Get Ready With Me' content featuring our bestsellers — no filters, no scripts, just honest skincare.",
    requirements: ["10K+ Followers", "Beauty or Skincare niche", "Reels with face cam"],
